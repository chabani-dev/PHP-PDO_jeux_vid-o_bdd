    ...
    <main class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-8">
                ...
                <a href="index.php?order=date" class="btn btn-secondary">Trier par date</a>&nbsp;
                <a href="index.php?order=platform" class="btn btn-light">Trier par plateforme</a>&nbsp;
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=date('d/m/Y',strtotime($videogame->release_date))?></td>
                        <td><?=ucfirst($videogame->platform)?></td>

                        <!-- TODO #5 construire un formulaire avec un champs unique qui prend l'id du jeu comme valeur, et un bouton pour la suppression, qui demande une confirmation(optionnel) -->
                        <td>
                            <form action="index.php" method="post">
                                <input type="text" value="<?=$videogame->id?>" name="id" class="d-none">
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce jeu ?');">Effacer</button>
                            </form>
                        </td>
            ...
            <div class="col-12 col-md-4">
                <div class="card">
                    <div class="card-header">Ajout jeu</div>
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="platform" name="platform">
                                    ...
                                    <?php foreach ($platformList as $platformId=>$platformName) : ?>
                                        <option value="<?= $platformId ?>"><?= ucfirst($platformName) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                ...
                <div class="card mt-4">
                    <div class="card-header">Ajout plateforme</div>
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="platformName">Nom</label>
                                <input type="text" class="form-control" name="platformName" id="platformName" placeholder="">
                            </div>
                            <button type="submit" class="btn btn-success btn-block mb-2">Ajouter</button>
                        </form>
                    </div>
